...
#import "ProgressCircleWorking.h"

@implementation ProgressCircleWorking
...
- (void)drawRect:(CGRect)rect {
    ...
    //large circle
    //int progress;
    progressWorking = 50;     //counter 0-100
    int limitInRadius = 60;
    
    UIBezierPath *path=[UIBezierPath bezierPath];
    [path setLineWidth:2];
    [path moveToPoint:CGPointMake(0, 0)];
    [path addArcWithCenter:CGPointMake(0, 0) radius:50 startAngle:0 endAngle:(progressWorking*3.6)*M_PI/180 clockwise:true];
    [path closePath];
